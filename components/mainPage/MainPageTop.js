    ...
    <div>
      <div className="relative ">
        <Image
          ...
          priority
        />
        <div className="absolute bottom-28 text-4xl left-20 text-gray-800 font-semibold z-50 ">
          Travel the
        </div>
        <div
          className="bg-white absolute z-40 bottom-0   text-8xl text-blue-700 
            ...
            {readMoreToggle && (
              ...
              >
                ...
                <p className="text-sm font-light text-gray-700 tracking-wider leading-7">
                  ...
                  the middle of the ocean, to volcanic fantasy-scapes concealing
                  hidden lagoons, to sprawling mega-islands such as Luzon and
                  Mindanao. Sun worshippers and divers should head straight to
                  the Visayas, where island-hopping opportunities abound and the
                  perfect beach takes many forms. More adventurous travelers can
                  pitch a tent on a deserted stretch of coastline in Palawan and
                  play solo <em>Survivor</em> for a few days.
                </p>
                <h2 className="my-10 font-semibold text-xl">
                  The Great Outdoors
                </h2>
                <p className="text-sm font-light text-gray-700 tracking-wider leading-7">
                  ...
                  trekking can be done just about anywhere, while mountain-bike
                  and canyoneering tours are gaining popularity. And the
                  Philippines is also, unofficially, the zipline capital of the
                  world.
                </p>
              </motion.div>
            )}
